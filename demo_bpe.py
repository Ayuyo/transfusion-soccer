...
Interactive Gradio demo for TransfusionSports — image-to-commentary generation.
...
def clean_commentary(text: str) -> str:
    """
    Light cleanup of BPE-decoded commentary.
    """
...
def build_interface(generator):
    ...
    examples_dir = getattr(generator, "examples_dir", None)
...
def main():
    ...
    if args.examples_dir:
        generator.examples_dir = args.examples_dir
